...
val dependencyLists = listOf(
  ...
  "io.opentelemetry.contrib:opentelemetry-aws-xray:1.39.99-adot1",
  "io.opentelemetry.contrib:opentelemetry-aws-resources:1.39.99-alpha-adot1",
